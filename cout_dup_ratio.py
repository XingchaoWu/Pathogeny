...
def count_dup(cur_path,sample_list):
    ...
    with open(cur_path + "/" + "dup_count.txt","w") as out_txt:
        ...
        for sample in sample_list:
            ...
            before_dup_cmd = "zcat /home/pmd/analysis/StandardTest/"+args.batch+"/se_v1/"+sample+"/map/"+sample+".non_human.exclude.fastq.gz |wc -l"
            # after_dup_cmd = "zcat /home/pmd/analysis/"+args.batch+"/se_v1/"+sample+"/map/"+sample+".non_human.exclude.dedup.fastq.gz |wc -l"
            after_dup_cmd = "zcat /home/pmd/analysis/StandardTest/"+args.batch+"/se_v1/"+sample+"/map/"+sample+".non_human.exclude.dedup.fastq.gz |wc -l"
