...
def taxonomy():
    ...
    cmd0 = "mkdir taxonomy"
    cmd1 = "cd taxonomy " + "&& " + "wget " + url
    cmd2 = "cd taxonomy " + "&& " + " tar -zxvf " + url.split("/")[5]
...
def download_assembly():
    ...
    refseq_url = ["ftp://ftp.ncbi.nlm.nih.gov/genomes/ASSEMBLY_REPORTS/assembly_summary_refseq.txt"]
    ...
    genbank_url = ["ftp://ftp.ncbi.nlm.nih.gov/genomes/ASSEMBLY_REPORTS/assembly_summary_genbank.txt"]
