...
def kraken_verificate_epd(kraken_path,kraken_edp_index,bracken_path,cur_path):
    ...
    # bracken
    # species
    cmd1 = "python " + bracken_path + " -k /home/pmd/Genome/fungi/kraken_eupathDB/database75mers.kmer_distrib -t 1  -l S -i " \
           + cur_path + "/" + args.sample_num + ".epd.kraken.report.txt" \
           + " -o " + cur_path + "/" + args.sample_num + ".epd.bracken.species.txt"
    # genus
    cmd2 = "python " + bracken_path + " -k /home/pmd/Genome/fungi/kraken_eupathDB/database75mers.kmer_distrib -t 1  -l G -i " \
           + cur_path + "/" + args.sample_num + ".epd.kraken.report.txt" \
...
if __name__ == '__main__':
    ...
    kraken_edp_index = "/home/pmd/Genome/fungi/kraken_eupathDB"
